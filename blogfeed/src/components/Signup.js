    ...
    return (
        <div style={{paddingTop:"112px"}}>
            ...
            <div className="neu card auth-card">
                    <h2 style={{color: "rgb(67 67 67)"}}>Everyblog</h2>
                    ...
                    <br/><br></br><button onClick={(e)=>postData(e)} style={{backgroundColor: "rgb(67 67 67)", color:"whitesmoke"}} className="btn waves-effect waves-light">Register</button>
                    <br/><br></br>
